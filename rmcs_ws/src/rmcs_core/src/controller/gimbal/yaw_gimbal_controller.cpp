...
public:
    YawGimbalController()
        ...
        register_output("/gimbal/bottom_yaw/control_angle_error", yaw_angle_error_, nan_);
...
PLUGINLIB_EXPORT_CLASS(
    rmcs_core::controller::gimbal::YawGimbalController, rmcs_executor::Component)